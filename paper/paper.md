...
![图 1 V4 模型架构](figures/fig1_architecture_v4.png)
...
![图 2 ENCODE 信号强度分布](figures/fig_encode_signal_profile.png)
...
![图 3 ROC 曲线对比](figures/fig_roc_comparison.png)

**图 3 不同模型配置的 ROC 曲线对比**

![图 4 混淆矩阵](figures/fig_confusion_matrix.png)

**图 4 V4 全特征模型的混淆矩阵**

![图 5 训练曲线](figures/fig_training_curves.png)
...
![图 6 全局归因分布](figures/fig_global_attribution.png)
...
![图 7 TSS 区域放大视图](figures/fig_tss_zoom.png)
...
![图 8 TSS 区域序列 Logo](figures/fig_sequence_logo_v4_tss.png)
...
![图 9 高/低表达组归因分数分布](figures/fig_group_comparison.png)
...
![图 10 归因方法交叉验证](figures/fig_dl_ig_correlation.png)
